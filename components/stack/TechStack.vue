          ...
          <div class="w-full h-full p-6 rounded-md">
            ...
            <div class="flex flex-row items-start w-full h-full gap-10 py-6 font-medium text-gray-500">
              <div class="flex flex-col gap-3 text-sm">Hardware<div
                  ...
                  <p v-for="device in hardware" class="flex items-center gap-2 leading-tight">
                    <svg class="w-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M4 5C4 4.44772 4.44772 4 5 4H19C19.5523 4 20 4.44772 20 5V15C20 15.5523 19.5523 16 19 16H5C4.44772 16 4 15.5523 4 15V5Z" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"></path>
                    <path d="M2 16H22V19C22 19.5523 21.5523 20 21 20H3C2.44772 20 2 19.5523 2 19V16Z" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"></path></svg>
                    {{ device.name }}
                 </p>
                </div>
